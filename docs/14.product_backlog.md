...
| US-002 | Como sistema quiero persistir `tenant` y asociar cada request de negocio a un `tenant_id` fiable (JWT + guards). | Prerequisito multi-tenant (`docs/08.data.md`). | [Spec](../specs/user-stories/US-002-tenant-persistence-and-request-context.md) |
